...
export type AnalysisReport = {
  ...
  technical: {ma5?: number; ma10?: number; ma20?: number; ma60?: number; rsi14?: number; support20?: number; resistance20?: number; high52w?: number; low52w?: number; volume_ratio?: number; trend: string; bar_count: number; atr14?: number; bollinger_width?: number; return_20d_pct?: number; return_60d_pct?: number; macd?: {dif: number; dea: number; hist: number; golden_cross: boolean; death_cross: boolean}};
  ...
  fund_flow: {trade_date?: string; main_inflow?: number; main_flow_ratio?: number; small_inflow?: number; medium_inflow?: number; large_inflow?: number; super_inflow?: number; source: string; endpoint?: string; fetched_at: string; status: string; error?: string; data_age_seconds?: number; cache_used?: boolean; cache_expired?: boolean};
  ...
  industry: {name?: string; rank?: number; total?: number; change_pct?: number; main_inflow?: number; source: string; endpoint?: string; fetched_at: string; status: string; error?: string; data_age_seconds?: number; cache_used?: boolean; cache_expired?: boolean};
